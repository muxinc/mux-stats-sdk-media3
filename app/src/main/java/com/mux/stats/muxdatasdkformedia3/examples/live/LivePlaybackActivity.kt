package com.mux.stats.muxdatasdkformedia3.examples.live
...
class LivePlaybackActivity : AppCompatActivity() {
  ...
  override fun onResume() {
    super.onResume()
    startPlaying(
      intent.getStringExtra(EXTRA_URL) ?: Constants.LIVE_TEST_BIG_BUCK_BUNNY
    )
  }
      ...
      .build().apply {
        addListener(object : Player.Listener {
          override fun onPlayerError(error: PlaybackException) {
            ...
            Toast.makeText(this@LivePlaybackActivity, error.localizedMessage, Toast.LENGTH_SHORT)
              .show()
          }
        })
      }
